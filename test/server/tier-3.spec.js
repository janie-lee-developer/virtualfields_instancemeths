...
describe("Tier 3: Virtual Fields, Route Parameters, DELETE Routes", () => {
  describe("Sequelize", () => {
    beforeEach(async () => {
      ...
      const places = [
        { category: "COUNTRY", place_name: "new york" },
        { category: "COUNTRY", place_name: "toronto" },
        { category: "COUNTRY", place_name: "vegas" },
        { category: "COUNTRY", place_name: "niagara falls" },
        { category: "COUNTRY", place_name: "hawaii" },
        { category: "COUNTRY", place_name: "korea" },
        { category: "COUNTRY", place_name: "korea 1" },
        { category: "COUNTRY", place_name: "korea 2" },
      ];
